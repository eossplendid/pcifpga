...
**********************************************************************/
unsigned long SmvErrAnalyse( SmvPacketInfo *firstPacketInfo, SmvPacketInfo *secondPacketInfo,/* SMV * pSmvCfgInfo,*/ int nDiffTime, int chNo);
...
**********************************************************************/
unsigned long GooseErrAnalyse( GoosePacketInfo *firstPacketInfo, GoosePacketInfo *secondPacketInfo,/* GOOSE * pGooseCfgInfo,*/ int nDiffTime, int chNo);
