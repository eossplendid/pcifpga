...
typedef struct WarningMsg
{
	unsigned short appId;
	unsigned char dstMac[MAX_MAC_LEN];
	unsigned int 	dataTime1;
	unsigned int 	dataTime2;
	unsigned char srcMac[MAX_MAC_LEN];
	unsigned char almCatg;
	unsigned char chNo;
}WarningMsg;								/*供告警上告使用*/

/*告警上报类型编码*/
#define	WARNING_ALMCATG_SMV				0x01				
#define	WARNING_ALMCATG_GOOSE			0x02
#define	WARNING_ALMCATG_MMS				0x03
#define	WARNING_ALMCATG_PTP				0x04
#define	WARNING_ALMCATG_GMRP			0x05
#define	WARNING_ALMCATG_NTP_SNTP		0x06
#define	WARNING_ALMCATG_ETH				0x0e
#define	WARNINGALMCATG_NET				0x0f
